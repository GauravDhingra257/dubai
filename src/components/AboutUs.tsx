    ...
    <div className="py-12 px-4 md:px-6 bg-white max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative">
        ...
        <div className="flex flex-col p-3 justify-center items-center">
          ...
          <p className="text-sm text-gray-600">
            Serving our clients is our goal, but listening to the people in our
            offices and using our intuition.
          </p>
        </div>
        ...
        <div className="flex flex-col p-3 justify-center items-center">
          ...
          <p className="text-sm text-gray-600">
            We ensure quality in every respect - both in the projects we deliver
        ...
        <div className="flex flex-col p-3 justify-center items-center">
          ...
          <p className="text-sm text-gray-600">
            Markets change and so do your needs. Infinite flexibility enables us
            to adapt swiftly to the future.
          </p>
        </div>
    ...
    <div className="max-w-5xl md:px-6 mx-auto px-4 py-12 font-sans">
      ...
      <div>
        ...
        <div className="text-sm text-gray-600 space-y-4">
          <p>
            I've had the privilege of working with industry giants like Google,
            Qualcomm, Symantec, and pioneering Silicon Valley startups.
            Throughout my career, I've tackled fascinating challenges at the
            forefront of technology. Insights and recognition have come my way,
            but I found something even more profound in this journey.
          </p>
          ...
          <p>
            ...
            fuels the heart of Technuvus. At Technuvus, our mission is clear: to
            generate true value for our users, clients, and, ultimately,
            humanity.
          </p>

          <p>
            We firmly believe that organizations should be conduits for positive
            change in the world. Technuvus aspires to be the trusted technology
            partner for each visionary enterprise. Our commitment is to harness
            the power of AI and technology to propel your mission and make a
