      ...
      <div className="flex justify-center max-w-5xl mx-auto">
        <Fade triggerOnce direction="left" cascade damping={0.1}>
          <div className=" w-full px-4 md:px-8 py-16">
            ...
            <p className="mb-8 text-sm md:text-md leading-relaxed">
              Our commitment to regulatory compliance and adherence to the
              highest industry standards is reflected in our official
              endorsements from esteemed government authorities, including
              ejari.gov.ae and services.dubailand.gov.ae. Through our
              established collaborations with reputable government authorities
              such as Dubai Economy, Dubai Chamber, Dubai Courts, Dubai
              Municipality, and others, we have cultivated a track record of
            ...
            <p className="mb-8 text-sm md:text-md leading-relaxed">
              ...
              the advertising partners of HA Group. Third-party ad servers or ad
              ...
              that appear on HA Group, which are sent directly to users'
            ...
            <p className="mb-16 text-sm md:text-md leading-relaxed">
              ...
              content that you see on websites that you visit. Note that HA
              Group has no access to or control over these cookies that are used
