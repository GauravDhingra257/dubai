    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="flex justify-center w-full">
        <div className="max-w-6xl w-full px-4 md:px-8 py-16">
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-blue-400 mb-12">
          ...
          <p className="mb-16 text-lg md:text-xl leading-relaxed">
          ...
          {/* Government section */}
          <h1 className="text-5xl md:text-6xl font-bold mb-2">Government</h1>
          <h2 className="text-5xl md:text-6xl font-bold text-blue-400 mb-12">
            Approved Entity
          </h2>
          ...
          {/* Consent Section */}
          <h2 className="text-4xl md:text-5xl font-bold mb-8">Consent</h2>
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-2">How we use</h2>
          ...
          <ul className="list-disc pl-8 mb-16 text-lg md:text-xl">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-2">Cookies and</h2>
          <h2 className="text-4xl md:text-5xl font-bold text-blue-400 mb-8">
            Web Beacons
          </h2>
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-2">Third Party</h2>
          <h2 className="text-4xl md:text-5xl font-bold text-blue-400 mb-8">
            Privacy Policies
          </h2>
          ...
          {/* CCPA Privacy Rights */}
          <h2 className="text-4xl md:text-5xl font-bold mb-2">CCPA</h2>
          <h2 className="text-4xl md:text-5xl font-bold text-blue-400 mb-8">
            Privacy Rights
          </h2>
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-2">Children's</h2>
          <h2 className="text-4xl md:text-5xl font-bold text-blue-400 mb-8">
            Information
          </h2>
